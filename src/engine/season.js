...
export function startCareer(){
  const p=G;
  p.age=16; p.year=1;
  trackEvent('career_start', { challenge: !!p.challengeId, daily: !!p.dailyDate });
  // Défi entre amis OU défi du jour (voir ui/challenge.js / engine/dailyChallenge.js) : les
  // offres d'académie sont FIGÉES par le défi (mêmes offres pour tous les participants) --
